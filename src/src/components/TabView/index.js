...
export default class TabCreate extends Component{
    ...
    componentWillMount() {
        ...
        this.props.fetchJSON("view",12345);
        ...
        **/
    	...
    	return (
				...
				<div className="cp-tab-container">
                    <Breadcrumb breadcrumbProp = {[{id:"firstItem",link:"Projects"},{id:"secondItem",link:">"},{id:"firstItem",link:"ProjectList"},{id:"secondItem",link:">"},{id:"lastItem",link:"View"}]}/>
