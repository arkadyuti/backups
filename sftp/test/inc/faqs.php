...
<div style="float:left;">
	<div style="background-color:white;width:665px;min-height: 600px;">
		<div class="FAQs_body">
...
dd.answer			{ background: white; 
					  position: relative; width: 70%;font-size: 15px; float: right; font-family: latoregular,Arial,sans-serif;display:none; }
