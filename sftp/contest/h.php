			...
			<div class="cont">
				<div class="header">
					...
					<div class="links">
						...
						echo '
						<div class="allstores" style="margin-right:0px;"  id="hide_cart">
							<a href="./cart.php" target="_blank">
								<div class="joinus" style="cursor:pointer;padding-left: 0px;width:89px;">
								<div class="new_cart" style="cursor:pointer;width:89px;">
									<div style="margin-left: 47px;">CART</div>
								</div>
								</div>
							</a>
							<style>
							.new_cart{
								background: url("./cart.png") 11px 5px no-repeat;
